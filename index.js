...
<div style="margin-top: 100px;margin-left: 10px;margin-right: 10px;">
            ...
            `+lock2+`<div style="display: flex;margin-top: 10px;">
                <div style="margin-left: 0;margin-right: 50.3%;background: linear-gradient( rgb(193 183 183), rgba(0,0,0,.5) ), url(./file/Disc2.png);background-repeat: no-repeat;background-size: cover;" onclick="linkBox3()" class="box2">
